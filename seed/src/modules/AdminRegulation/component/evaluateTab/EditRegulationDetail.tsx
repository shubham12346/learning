...
const EditRegulationDetail = (props: editRegulationType) => {
  ...
  const { regulationDetailLoading, regulationListLoading } = useSelector(
    (state: RootState) => state.adminRegulation
  );
    ...
    <Box sx={{ pl: smallDevice ? '' : 5 }} className="regulationsSummary">
      <Box>
        <Card>
          ...
          {regulationDetailLoading && regulationListLoading ? (
              ...
              <Box className="regulationCalendarPadding">
                ...
                <Box className="regulationObligation mb-24">
                  <RegulationObligationList
                    ...
                    buttonText="Add Obligation"
                    heading="Regulation Obligation"
...
export default EditRegulationDetail;
