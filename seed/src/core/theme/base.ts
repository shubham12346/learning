...
declare module '@mui/material/styles' {
  ...
  interface ThemeOptions {
    colors: {
      ...
      themeColor: {
        primary: string;
        primary_shade_02: string;
        secondary: string;
        neutral: string;
        neutral_shade_02: string;
        neutral_shade_03: string;
        neutral_shade_04: string;
        surface_shade_01: string;
        surface_shade_02: string;
        surface_shade_03: string;
        primaryAlt: string;
        trueWhite: string;
      };
    };
